...
Singleton {
    ...
    function setScheme(name: string, flavour: string, mode: string, variant: string): void {
        Quickshell.execDetached(["caelestia", "scheme", "set", "--notify", "-n", name, "-f", flavour, "-m", mode, "-v", variant]);
    }
